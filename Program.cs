...
using ConsoleApp006.Models;
using Newtonsoft.Json;

namespace ConsoleApp006
{
    internal class Program
    {
        ...
        public static void GetAllPeople()
        {
            ...
            {
                Person person = new JsonSerializer.Deserialize<Person>(itemJson);
                people.Add(person);
            }
        ...
        public static void RemovePerson()
        {
            ...
            foreach (Person person in people)
            {
                strin jsonPerson = JsonSerializer.Serialize(person);
